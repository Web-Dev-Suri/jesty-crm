#  JESTYCRM Софтуер за управление на отворен код ERP & CRM
...
## Стек от софтуерни технологии
 ...
 JESTYCRM е безплатен софтуер с отворен код за управление на ERP & CRM приложения, базиран на "mern-stack": Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
